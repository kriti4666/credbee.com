      ...
      <LoginSection style={{ background: "white" }} >
        <LoginSectionLeftDiv>
          ...
          <Box style={{ display: "flex" }} >
            <img style={{ width: "200px", marginTop: -88 }} src="https://webstatic.chargebee.com/assets/web/535/images/summer-release/summer-release-bg.svg" alt="image2"></img>
            <Typography sx={{ marginTop: 2, textAlign: "justify", marginLeft: 2, fontSize: 15 }}>
